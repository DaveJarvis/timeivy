...
"<td";[0,3,4].includes(a)?(e+=' class="'+d+'">',0===a&&(a=moment().startOf("month").subtract(1,"day"),a=b.getNextWorkDay(a),e+=a.format(c.format_date))):e+=">";e+="</td>"});e+="</tr>";a.append(e)},getNextWorkDay:function(b){var a=this.preferences;b=b.clone();do b.add(1,"day");while(a.weekends&&b.toDate().isWeeeknd());return b},refreshCells:function(){for(var b=this.ivy.getMaxRows(),a=0;a<=b;a++)this.onCellValueChangeAfter(a,1)},onCellValueChangeBefore:function(b,a,c){if(1===c||2===c)b=b.toTime();
return b},onCellValueChangeAfter:function(b,a){if(1===a||2===a){a=this.ivy;var c=this.preferences,d=this.updateCellTime(b,1),e=this.updateCellTime(b,2,d,60);d=moment.duration(e.diff(d)).asHours();d.toFixed&&(d=Math.abs(d).toFixed(c.format_prec));$(a.getCell(b,3)).text(d);b=this.findConsecutive(b,0);c=this.sumConsecutive(b);$(a.getCell(b[0],4)).text(c)}},onRowInsertAfter:function(b,a){b=this.ivy;var c=a.find("td:eq(2)").text();a.find("td:not(:first-child)").empty();a=a.index();b.setCellValue(c,a,1);
b.refreshCells()},onRowAppendAfter:function(b,a){var c=this.ivy;a=a.find("td:first");var d=moment(a.text()),e=d.month();d=this.getNextWorkDay(d);var g=d.month();e===g?a.text(d.format(this.preferences.format_date)):b.remove();c.refreshCells()},updateCellTime:function(b,a,c,d){var e=this.preferences;b=$(this.ivy.getCell(b,a));a=b.text();""==a&&(a=moment(c).add(d,"minutes"),a=a.format(e.format_time),b.text(a));return moment.utc(a,e.format_time)},findConsecutive:function(b,a){for(var c=this.ivy,d=b,e=
$(c.getCell(b,a)).text(),g=e;e==g&&0<=--d;)g=$(c.getCell(d,a)).text();var h=d+1,k=c.getMaxRows();d=b;for(g=e;e==g&&++d<k;)g=$(c.getCell(d,a)).text();return[h,d-1]},sumConsecutive:function(b){for(var a=this.ivy,c=this.preferences,d=0,e=b[0];e<=b[1];e++)d+=parseFloat($(a.getCell(e,3)).text(),10)||0;d.toFixed&&(d=d.toFixed(c.format_prec));return d}});$.extend(!0,c,{editAppendMonth:function(){var b=this.getMaxRows(),a=$(this.getCell(b,0));a=moment(a.text());for(b=a.month();b===a.add(1,"day").month();)this.editAppendRow(),
a=$(this.getCellLastRow(0)),a=moment(a.text())}});$("#timesheet").dialog({dialogClass:"settings-dialog",position:{my:"right bottom",at:"right bottom",of:window}});$(".app-edit-undo").on("click",function(b){c.editUndo()});$(".app-edit-redo").on("click",function(b){c.editRedo()});$(".app-insert-shift").on("click",function(b){c.editInsertRow()});$(".app-delete-row").on("click",function(b){c.editDeleteRow()});$(".app-append-day").on("click",function(b){c.editAppendRow()});$(".app-append-days").on("click",
function(b){c.editAppendMonth()});$(".app-settings-timesheet").on("click",function(b){$("#timesheet").dialog("open")})});
