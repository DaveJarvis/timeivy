...
String.prototype.toTime=function(){var a=this,d=!1,c=!1,b=0,f=0;null!=a?(d=null!==a.match(/p/i),c=null!==a.match(/a/i),a=a.replace(/^00/,"24"),a=parseInt(a.replace(/\D/g,""),10)):a=0;0<a&&24>a?b=a:100<=a&&2359>=a?(b=~~(a/100),f=a%100):2400<=a&&(f=a%100,d=!1);12==b&&!1===c?d=!0:12<b&&(d=!0,b-=12);59<f&&(f=59);return(""+b).padLeft("00")+":"+(""+f).padLeft("00")+" "+(d?"PM":"AM")};Storage.prototype.put=function(a,d){this.setItem(a,CJSON.stringify(d))};
Storage.prototype.get=function(a,d){a=this.getItem(a);return null===a?d:CJSON.parse(a)};(function(a,d,c,b){function f(e,b){this.element=e;this.settings=a.extend({},h,b);this.settings.ivy=this;this._defaults=h;this._name="ivy";this._cell=[0,0];this._$cellInput=!1;this._commandExecutor=new k;this.init()}var h={classActiveCell:"active",classActiveCellInput:"edit",classCellReadOnly:"readonly",maxPageSize:30,dispatchKeysNavigate:[{k:"enter",f:"navigateDown"},{k:"up",f:"navigateUp"},{k:"down",f:"navigateDown"},{k:"left",f:"navigateLeft"},{k:"right",f:"navigateRight"},{k:"ctrl+up",f:"navigateUpSkip"},
...
refreshCells:function(){},onCellValueChangeBefore:function(e,a,b){return e},onCellValueChangeAfter:function(e,a){},onRowInsertAfter:function(e,a){},onRowAppendAfter:function(e,a){},onRowDeleteAfter:function(e){}};a.extend(f.prototype,{init:function(){this.settings.init();this.refreshCells();this.setup();this.bindNavigateMode();this.bindPrintableKeys();this.bindNavigationClicks();this.bindPasteHandler();this.activate()},refreshCells:function(){this.settings.refreshCells()},setup:function(){Mousetrap.prototype.stopCallback=
...
g.prototype.equals=function(a){return"undefined"===typeof a?!1:Object.equals(this.getState(),a.getState())};g.prototype.undo=function(){var a=this.getPlugin();a.cellStateRestore(this.getState());a.refreshCells()};g.prototype.getId=function(){return(new Date).getTime()};g.prototype.saveState=function(){this.setState(this.getPlugin().cellStateRetrieve())};g.prototype.setState=function(a){this._state=a};g.prototype.getState=function(){return this._state};g.prototype.getPlugin=function(){return this._plugin};
var n=function(a,b,c){a=g.call(this,a)||this;a._row=b;a._col=c;return a};$jscomp.inherits(n,g);n.prototype.execute=function(){this.getPlugin()._navigate(this._row,this._col)};var m=function(a){return g.call(this,a)||this};$jscomp.inherits(m,g);m.prototype.execute=function(){var a=this.getPlugin();a.editCopy();a.editErase()};var l=function(a,b){a=g.call(this,a)||this;a._charCode=b;return a};$jscomp.inherits(l,g);l.prototype.execute=function(){var b=this.getPlugin();b.bindEditMode();b.unbindPrintableKeys();
var c=a(b.getActiveCell()),f=b.cellInputCreate(c,this._charCode);console.log(c.html());b.setCellInput(f);c.html(f);f.focus();f.on("focusout",function(){b.editStop()})};var q=function(a,b){a=g.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(q,g);q.prototype.execute=function(){this.getPlugin().setActiveCellValue(this._cellValue)};var u=function(a,b){a=g.call(this,a)||this;a._columnName=b;return a};$jscomp.inherits(u,g);u.prototype.execute=function(){var b=this.getPlugin();b.deactivate();
a(b.getTableBodyElement()).parent().find("thead");b.activate()};var p=function(a){return g.call(this,a)||this};$jscomp.inherits(p,g);p.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var b=this.getRow().clone();this.setState({id:this.getId(),clone:b});this.inject(b);a.activate()};p.prototype.inject=function(a){var b=this.getRow();b.after(a);this.getPlugin().settings.onRowInsertAfter(b,a)};p.prototype.undo=function(){this.getState().clone.remove();this.getPlugin().refreshCells()};
p.prototype.getRow=function(){return a(this.getPlugin().getActiveCell()).closest("tr")};var t=function(a){return p.call(this,a)||this};$jscomp.inherits(t,p);t.prototype.inject=function(a){var b=this.getRow();b.after(a);this.getPlugin().settings.onRowAppendAfter(b,a)};t.prototype.getRow=function(){return a(this.getPlugin().getTableBodyElement()).find("tr:last")};var r=function(a){return g.call(this,a)||this};$jscomp.inherits(r,g);r.prototype.execute=function(){var b=this.getPlugin();b.deactivate();
...
b[a.i].f]()}}(h));$(".ivy-export-csv").exportable({source:a.element,filename:"timesheet.csv"});$(".ivy-export-json").exportable({source:a.element,filename:"timesheet.json"})},initHeadings:function(){for(var a=$(this.ivy.getTableBodyElement()).prev("thead").find("tr:first"),b=this.getPreferences().columns,f=b.length,h="",k=0;k<f;k++)h+="<th>"+b[k]+"</th>";a.append(h)},initTimesheet:function(){var a=this,b=a.ivy,f=a.getPreferences(),h=b.settings.classCellReadOnly;b=$(b.getTableBodyElement());var k=
b.prev("thead").find("tr:first > th"),g="<tr>",d=f.formats.format_date;k.each(function(b){g+="<td";[0,3,4].includes(b)?(g+=' class="'+h+'">',0===b&&(b=moment().startOf("month").subtract(1,"day"),b=a.getNextWorkDay(b),g+=b.format(d))):g+=">";g+="</td>"});g+="</tr>";b.append(g)},initPreferencesDialog:function(){$("#settings").dialog({dialogClass:"settings-dialog",autoOpen:!1,maxHeight:.75*$(window).height(),height:"auto",width:"auto",closeOnEscape:!0,position:{my:"right top",at:"right top",of:window},
buttons:{Ok:function(){$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});$(".app-settings-preferences").on("click",function(a){$("#settings").dialog("open")})},initPreferencesEditor:function(){var c=document.getElementById("editor");new JSONEditor(c,{theme:"jqueryui",disable_collapse:!0,disable_edit_json:!0,disable_properties:!0,disable_array_reorder:!0,disable_array_delete_all_rows:!0,disable_array_delete_last_row:!0,required_by_default:!0,no_additional_properties:!0,remove_empty_properties:!0,
schema:a,startval:this.getPreferences()})},getNextWorkDay:function(a){var b=this.getPreferences();a=a.clone();do a.add(1,"day");while(!b.inclusion.weekends&&a.toDate().isWeekend());return a},refreshCells:function(){for(var a=this.ivy.getMaxRows(),b=0;b<=a;b++)this.onCellValueChangeAfter(b,1)},onCellValueChangeBefore:function(a,b,f){if(1===f||2===f)a=a.toTime();return a},onCellValueChangeAfter:function(a,b){if(1===b||2===b){b=this.ivy;var c=this.getPreferences(),h=this.updateCellTime(a,1),k=this.updateCellTime(a,
2,h,60);h=moment.duration(k.diff(h)).asHours();h.toFixed&&(h=Math.abs(h).toFixed(c.formats.format_prec));$(b.getCell(a,3)).text(h);a=this.findConsecutive(a,0);c=this.sumConsecutive(a);$(b.getCell(a[0],4)).text(c)}},onRowInsertAfter:function(a,b){a=this.ivy;var c=b.find("td:eq(2)").text();b.find("td:not(:first-child)").empty();b=b.index();a.setCellValue(c,b,1);a.refreshCells()},onRowAppendAfter:function(a,b){var c=this.ivy;b=b.find("td:first");var h=moment(b.text()),k=h.month();h=this.getNextWorkDay(h);
var g=h.month();k===g?(a=this.getPreferences(),b.text(h.format(a.formats.format_date))):a.remove();c.refreshCells()},updateCellTime:function(a,b,f,h){var c=this.ivy,g=this.getPreferences();a=$(c.getCell(a,b));b=a.text();""==b&&(b=moment(f).add(h,"minutes"),b=b.format(g.formats.format_time),a.text(b));return moment.utc(b,g.formats.format_time)},findConsecutive:function(a,b){for(var c=this.ivy,h=a,k=$(c.getCell(a,b)).text(),g=k;k==g&&0<=--h;)g=$(c.getCell(h,b)).text();var d=h+1,m=c.getMaxRows();h=a;
for(g=k;k==g&&++h<m;)g=$(c.getCell(h,b)).text();return[d,h-1]},sumConsecutive:function(a){for(var b=this.ivy,c=this.getPreferences(),h=0,k=a[0];k<=a[1];k++)h+=parseFloat($(b.getCell(k,3)).text(),10)||0;h.toFixed&&(h=h.toFixed(c.formats.format_prec));return h}});$.extend(!0,d,{editAppendMonth:function(){var a=this.getMaxRows(),b=$(this.getCell(a,0));b=moment(b.text());for(a=b.month();a===b.add(1,"day").month();)this.editAppendRow(),b=$(this.getCellLastRow(0)),b=moment(b.text())}})});(function(a,d,c,b){function f(b,c){this.element=b;this.settings=a.extend({},h,c);this._defaults=h;this._name="exportable";this.init()}var h={source:"table",filename:"export.csv",exports:{csv:{file_extension:"csv",media_type_text:"text/csv",media_type_data:"application/csv",col_delimiter:'","',row_delimiter:'"\r\n"',temp_col_delimiter:String.fromCharCode(11),temp_row_delimiter:String.fromCharCode(0)},json:{file_extension:"json",media_type_text:"text/plain",media_type_data:"application/json"}},charset:"utf-8"};
