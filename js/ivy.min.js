...
$jscomp.findInternal=function(a,d,b){a instanceof String&&(a=String(a));for(var c=a.length,g=0;g<c;g++){var k=a[g];if(d.call(b,k,g,a))return{i:g,v:k}}return{i:-1,v:void 0}};$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,d,b){a!=Array.prototype&&a!=Object.prototype&&(a[d]=b.value)};$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);
...
$jscomp.polyfill("Array.prototype.includes",function(a){return a?a:function(a,b){var c=this;c instanceof String&&(c=String(c));var g=c.length;for(b=b||0;b<g;b++)if(c[b]==a||Object.is(c[b],a))return!0;return!1}},"es7","es3");
...
String.prototype.toTime=function(){var a=this,d=!1,b=!1,c=0,g=0;null!=a?(d=null!==a.match(/p/i),b=null!==a.match(/a/i),a=a.replace(/^00/,"24"),a=parseInt(a.replace(/\D/g,""),10)):a=0;0<a&&24>a?c=a:100<=a&&2359>=a?(c=~~(a/100),g=a%100):2400<=a&&(g=a%100,d=!1);12==c&&!1===b?d=!0:12<c&&(d=!0,c-=12);59<g&&(g=59);return(""+c).padLeft("00")+":"+(""+g).padLeft("00")+" "+(d?"PM":"AM")};Storage.prototype.put=function(a,d){this.setItem(a,LZString.compressToUTF16(d.encode()))};
Storage.prototype.get=function(a,d){a=this.getItem(a);return null===a?d:LZString.decompressFromUTF16(a).decode()};(function(a,d,b,c){function g(e,b){this.element=e;this.settings=a.extend({},k,b);this.settings.ivy=this;this._defaults=k;this._name="ivy";this._cell=[0,0];this._$cellInput=!1;this._commandExecutor=new h;this.init()}var k={classActiveCell:"ivy-active",classActiveCellInput:"ivy-editor",classCellReadOnly:"ivy-readonly",maxPageSize:30,dispatchKeysNavigate:[{k:"enter",f:"navigateDown"},{k:"up",f:"navigateUp"},{k:"down",f:"navigateDown"},{k:"left",f:"navigateLeft"},{k:"right",f:"navigateRight"},{k:"ctrl+up",
...
refreshCells:function(){},onCellValueChangeBefore:function(e,a,b){return e},onCellValueChangeAfter:function(e,a){},onRowInsertAfter:function(e,a){},onRowAppendAfter:function(e,a){},onRowDeleteAfter:function(e){}};a.extend(g.prototype,{init:function(){this.settings.init();this.setup();this.bindNavigateMode();this.bindPrintableKeys();this.bindNavigationClicks();this.bindPasteHandler();this.activate()},refreshCells:function(){this.settings.refreshCells()},setup:function(){Mousetrap.prototype.stopCallback=
...
this.getPlugin().onRowInsertAfter(b,a)};l.prototype.undo=function(){this.getState().clone.remove()};l.prototype.getRow=function(){return a(this.getPlugin().getActiveCell()).closest("tr")};var q=function(a){return l.call(this,a)||this};$jscomp.inherits(q,l);q.prototype.inject=function(a){var b=this.getRow();b.after(a);this.getPlugin().onRowAppendAfter(b,a)};q.prototype.getRow=function(){return a(this.getPlugin().getTableBodyElement()).find("tr:last")};var p=function(a){return f.call(this,a)||this};
$jscomp.inherits(p,f);p.prototype.execute=function(){var b=this.getPlugin();b.deactivate();var c=a(b.getActiveCell()).closest("tr");this.setState({id:this.getId(),row:c});c.remove();b.onRowDeleteAfter(c);b.activate()};p.prototype.undo=function(){this.getPlugin().editInsertRow()};a.fn.ivy=function(b){var c;this.each(function(){a.data(this,"plugin_ivy")||(c=new g(this,b),a.data(this,"plugin_ivy",c))});return c};d.Plugin=g})(jQuery,window,document);$(document).ready(function(){var a={description:"Control application behaviour.",title:"Preferences",type:"object",properties:{active:{description:"Edit timesheet data for this month.",type:"string",format:"date",title:"Active Month"},weekdays:{description:"Predefine daily timeslots.",type:"array",title:"Weekdays",format:"table",uniqueItems:!0,items:{type:"object",required:"weekday",properties:{weekday:{title:"Weekday",type:"string","enum":[0,1,2,3,4,5,6],options:{enum_titles:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")}},
...
type:"string",title:"Time","default":"HH:mm A"},format_prec:{description:"Decimal places to show for time calculations.",type:"integer",title:"Precision","default":2},format_keys:{description:"Internal format used as timesheet key index for local data storage.",type:"string",title:"Primary Key","default":"YYYYMM"}}}}},d=$("#ivy tbody").ivy({init:function(){this.initMenu();this.initHeadings();this.initTimesheet();this.fillTimesheet();this.initPreferencesDialog();this.initPreferencesEditor();this.initSuperhero();
this.setChanged(!1)},initMenu:function(){for(var a=this.getPlugin(),c=[{a:"edit-cut",f:"Cut"},{a:"edit-copy",f:"Copy"},{a:"edit-undo",f:"Undo"},{a:"edit-redo",f:"Redo"},{a:"insert-shift",f:"InsertRow"},{a:"delete-row",f:"DeleteRow"},{a:"append-day",f:"AppendRow"}],g=c.length,k={i:0};k.i<g;k={i:k.i},k.i++)$(".app-"+c[k.i].a).on("click",function(a){return function(b){d["edit"+c[a.i].f]()}}(k));this._exporter_csv=$(".ivy-export-csv").exportable({source:a.element,filename:"timesheet.csv"});this._exporter_json=
$(".ivy-export-json").exportable({source:a.element,filename:"timesheet.json"})},initHeadings:function(){var a=this.getPlugin();a=$(a.getTableBodyElement()).prev("thead").find("tr:first");for(var c=this.getPreferences().columns,g=c.length,d="",h=0;h<g;h++)d+="<th>"+c[h]+"</th>";a.append(d)},initTimesheet:function(){var a=this,c=a.getPlugin(),g=a.getPreferences(),d=g.formats.format_date;moment().format(g.formats.format_keys);var h=c.settings.classCellReadOnly;c=$(c.getTableBodyElement());var f="<tr>";
c.prev("thead").find("tr:first > th").each(function(b){f+="<td";[0,3,4].includes(b)?(f+=" class='"+h+"'>",0===b&&(b=moment().startOf("month").subtract(1,"day"),b=a.getNextWorkDay(b),f+=b.format(d))):f+=">";f+="</td>"});f+="</tr>";c.append(f)},fillTimesheet:function(){},initPreferencesDialog:function(){$("#settings").dialog({dialogClass:"settings-dialog",autoOpen:!1,maxHeight:.75*$(window).height(),height:"auto",width:"auto",closeOnEscape:!0,position:{my:"right top",at:"right top",of:window},buttons:{Ok:function(){$(this).dialog("close")},
Cancel:function(){$(this).dialog("close")}}});$(".app-settings-preferences").on("click",function(a){$("#settings").dialog("open")})},initPreferencesEditor:function(){var b=document.getElementById("editor");new JSONEditor(b,{theme:"jqueryui",disable_collapse:!0,disable_edit_json:!0,disable_properties:!0,disable_array_reorder:!0,disable_array_delete_all_rows:!0,disable_array_delete_last_row:!0,required_by_default:!0,no_additional_properties:!0,remove_empty_properties:!0,schema:a,startval:this.getPreferences()})},
initSuperhero:function(){var a=this,c=a.getPreferences();$(window).on("unload",function(){a.save()});setInterval(function(){a.save()},1E3*c.saving.timeout)},getNextWorkDay:function(a){var b=this.getPreferences();a=a.clone();do a.add(1,"day");while(!b.inclusion.weekends&&a.toDate().isWeekend());return a},refreshCells:function(){for(var a=this.getPlugin().getMaxRows(),c=0;c<=a;c++)this.onCellValueChangeAfter(c,1)},onCellValueChangeBefore:function(a,c,d){if(1===d||2===d)a=a.toTime();return a},onCellValueChangeAfter:function(a,
c){if(1===c||2===c){c=this.getPlugin();var b=this.getPreferences(),d=this.updateCellTime(a,1),h=this.updateCellTime(a,2,d,60);d=moment.duration(h.diff(d)).asHours();d.toFixed&&(d=Math.abs(d).toFixed(b.formats.format_prec));$(c.getCell(a,3)).text(d);a=this.findConsecutive(a,0);b=this.sumConsecutive(a);$(c.getCell(a[0],4)).text(b);this.setChanged(!0)}},onRowInsertAfter:function(a,c){a=this.getPlugin();var b=c.find("td:eq(2)").text();c.find("td:not(:first-child)").empty();c=c.index();a.setCellValue(b,
c,1);a.refreshCells()},onRowAppendAfter:function(a,c){c=c.find("td:first");var b=moment(c.text()),d=b.month();b=this.getNextWorkDay(b);var h=b.month();d===h?(a=this.getPreferences(),c.text(b.format(a.formats.format_date))):a.remove();this.getPlugin().refreshCells()},updateCellTime:function(a,c,d,k){var b=this.getPlugin(),f=this.getPreferences();a=$(b.getCell(a,c));c=a.text();""==c&&(c=moment(d).add(k,"minutes"),c=c.format(f.formats.format_time),a.text(c));return moment.utc(c,f.formats.format_time)},
findConsecutive:function(a,c){for(var b=this.getPlugin(),d=a,h=$(b.getCell(a,c)).text(),f=h;h==f&&0<=--d;)f=$(b.getCell(d,c)).text();var m=d+1,n=b.getMaxRows();d=a;for(f=h;h==f&&++d<n;)f=$(b.getCell(d,c)).text();return[m,d-1]},sumConsecutive:function(a){for(var b=this.getPlugin(),d=this.getPreferences(),k=0,h=a[0];h<=a[1];h++)k+=parseFloat($(b.getCell(h,3)).text(),10)||0;k.toFixed&&(k=k.toFixed(d.formats.format_prec));return k},setChanged:function(a){this._changed=a},getChanged:function(){return this._changed},
getDataStore:function(){return localStorage},put:function(a,c){this.getDataStore().put(a,c)},get:function(a,c){return this.getDataStore().get(a,c)},loadTimesheet:function(){var a=this.getTimesheetKey(),c=this.get(key);console.log(a);console.log(c)},saveTimesheet:function(){var a=this.getTimesheetKey(),c=this.getTimesheetData();console.log(a);console.log(c)},getTimesheetKey:function(){var a=this.getPreferences();return moment(a.active,"YYYY-MM-DD").format(a.formats.format_keys)},getTimesheetData:function(){return"hello, world"},
save:function(){this.getChanged()&&(this.setChanged(!1),this.saveTimesheet())},getDefaultPreferences:function(){return{active:moment().format("YYYY-MM-01"),formats:{format_date:"YYYY-MM-DD",format_time:"hh:mm A",format_prec:2,format_keys:"YYYYMM"},weekdays:[{weekday:1,times:[{began:"745",ended:"930"},{began:"930",ended:"1000"},{began:"1000",ended:"345p"}]}],saving:{timeout:5},inclusion:{weekends:!1,holidays:!1},columns:["Description"]}},getPreferences:function(){return this.get("ivy.preferences",
this.getDefaultPreferences())},setPreferences:function(a){this.put("ivy.preferences",a)},getPlugin:function(){return this.ivy}});$.extend(!0,d,{editAppendMonth:function(){var a=this.getMaxRows(),c=$(this.getCell(a,0));c=moment(c.text());for(a=c.month();a===c.add(1,"day").month();)this.editAppendRow(),c=$(this.getCellLastRow(0)),c=moment(c.text())}})});(function(a,d,b,c){function g(b,c){this.element=b;this.settings=a.extend({},k,c);this._defaults=k;this._name="exportable";this.init()}var k={source:"table",filename:"export.csv",exports:{csv:{file_extension:"csv",media_type_text:"text/csv",media_type_data:"application/csv",col_delimiter:'","',row_delimiter:'"\r\n"',temp_col_delimiter:String.fromCharCode(11),temp_row_delimiter:String.fromCharCode(0)},json:{file_extension:"json",media_type_text:"text/plain",media_type_data:"application/json"}},charset:"utf-8"};
a.extend(g.prototype,{init:function(){var b=this,c=b.settings.filename,d=c.slice((c.lastIndexOf(".")-1>>>0)+2);a(b.element).on("click tap",function(a){b[d]()})},export_csv:function(){var b=this.settings,c=b.exports,d=c.csv.temp_row_delimiter,g=c.csv.temp_col_delimiter,k=c.csv.row_delimiter;c=c.csv.col_delimiter;return'"'+a(b.source).find("tr:has( td )").map(function(b,c){return a(c).find("td").map(function(b,c){return a(c).text().replace(/"/g,'""')}).get().join(g)}).get().join(d).split(d).join(k).split(g).join(c)+
'"'},csv:function(){var a=this.settings.exports,b=this.export_csv();this.download(b,a.csv)},export_json:function(){var b=this.settings.source,c=[];a.each(a(b).parent().find("thead > tr > th"),function(b,d){c.push(a(d).text().toLowerCase())});var d=[];a.each(a(b).find("tr"),function(f,h){var g={};a.each(a(b).find("td"),function(b,d){g[c[b]]=a(this).text().trim()});d.push(g)});return JSON.stringify(d)},json:function(){var a=this.settings.exports,b=this.export_json();this.download(b,a.json)},download:function(b,
c){var f=this.settings;d.Blob&&d.URL?(b=new Blob([b],{type:c.meda_type_text+"; charset="+f.charset}),b=URL.createObjectURL(b)):b="data:"+c.media_type_data+"; charset="+f.charset+","+encodeURIComponent(b);a(this.element).attr({download:f.filename,href:b,target:""})}});a.fn.exportable=function(b){var c;this.each(function(){a.data(this,"plugin_exportable")||(c=new g(this,b),a.data(this,"plugin_exportable",c))});return c};d.Plugin=g})(jQuery,window,document);
