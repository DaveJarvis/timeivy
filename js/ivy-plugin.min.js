...
f:"navigateDownSkip"},{k:"ctrl+left",f:"navigateLeftSkip"},{k:"ctrl+right",f:"navigateRightSkip"},{k:"pageup",f:"navigatePageUp"},{k:"pagedown",f:"navigatePageDown"},{k:"ctrl+pageup",f:"navigateSheetFore"},{k:"ctrl+pagedown",f:"navigateSheetAnte"},{k:"home",f:"navigateRowHome"},{k:"end",f:"navigateRowEnd"},{k:"ctrl+home",f:"navigateHome"},{k:"ctrl+end",f:"navigateEnd"},{k:"shift+tab",f:"navigateLeft"},{k:"tab",f:"navigateRight"},{k:"ctrl+x",f:"cellCut"},{k:"ctrl+c",f:"cellCopy"},{k:"ctrl+ins",f:"cellCopy"},
{k:"del",f:"cellErase"},{k:"f2",f:"cellEditStart"},{k:"esc",f:"cellEditCancel"},{k:"ins",f:"editInsertRow"},{k:"ctrl+i",f:"editInsertRow"},{k:"ctrl+s",f:"editSave"},{k:"ctrl+z",f:"editUndo"},{k:"ctrl+shift+z",f:"editRedo"},{k:"ctrl+y",f:"editRedo"}],modeEdit:[{k:"up",f:"navigateUp"},{k:"down",f:"navigateDown"},{k:"enter",f:"cellEditStop"}]};b.extend(m.prototype,{init:function(){this.setup();this.bindNavigateMode();this.bindPrintableKeys();this.bindNavigationClicks();this.bindPasteHandler();this.activate()},
setup:function(){Mousetrap.prototype.stopCallback=function(a,d,b){a.preventDefault();return!1}},navigateTableCell:function(a){var d=a.parent().children().index(a);a=a.parent().parent().children().index(a.parent());!1===this.isActiveCell(a,d)&&this.navigate(a,d)},bindNavigationClicks:function(){var a=this,d=b(a.getTableBodyElement());d.on("click","td",function(){a.navigateTableCell(b(this))});d.on("dblclick","td",function(){a.navigateTableCell(b(this));a.cellEditStart()})},bindPrintableKeys:function(){var a=
b(this.getTableBodyElement());a.keypress(function(a){var d="number"===typeof a.which?a.which:a.keyCode;"keypress"===a.type&&d&&!a.ctrlKey&&console.log("KEYPRESS!")});a.focus()},bindNavigateMode:function(){Mousetrap.reset();for(var a=this,d=this.settings.modeNavigate,b={},c=0;c<d.length;b={f:b.f},c++){var e=d[c].k;b.f=d[c].f;Mousetrap.bind(e,function(d){return function(b){eval("plugin."+d.f).call(a)}}(b))}},bindPasteHandler:function(){var a=this;b(e).on("paste",function(d){if(d.originalEvent){var b=
d.originalEvent.clipboardData.getData("text");a.execute(new h(a,b));d.stopPropagation();d.preventDefault()}})},sanitizeCellIndex:function(a,d){return a>d?d:0>a?0:a},getCellRow:function(){return this._cell[0]},getCellCol:function(){return this._cell[1]},getTableBodyElement:function(){return b(this.element)[0]},getTableCell:function(){var a=this.getTableBodyElement(),d=this.getCellRow(),b=this.getCellCol();return a.rows[d].cells[b]},setCellRow:function(a){var b=this.getTableBodyElement().rows.length-
1;this._cell[0]=this.sanitizeCellIndex(a,b)},setCellCol:function(a){var b=this.getTableBodyElement(),c=this.getCellRow();this._cell[1]=this.sanitizeCellIndex(a,b.rows[c].cells.length-1)},isActiveCell:function(a,b){return this.isActiveCellRow(a)&&this.isActiveCellCol(b)},isActiveCellRow:function(a){return a===this.getCellRow()},isActiveCellCol:function(a){return a===this.getCellCol()},isActiveCellReadOnly:function(){return b(this.getTableCell()).hasClass(this.settings.classCellReadOnly)},activate:function(){b(this.getTableCell()).addClass(this.settings.classActiveCell)},
deactivate:function(){b(this.getTableCell()).removeClass(this.settings.classActiveCell)},cellStateRetrieve:function(){return{cellRow:this.getCellRow(),cellCol:this.getCellCol(),cellVal:b(this.getTableCell()).text()}},cellStateRestore:function(a){this._navigate(a.cellRow,a.cellCol);b(this.getTableCell()).text(a.cellVal)},getCommandExecutor:function(){return this._commandExecutor},execute:function(a){this.getCommandExecutor().execute(a)},_navigate:function(a,d){this.deactivate();this.setCellRow(a);
this.setCellCol(d);this.activate();b(this.getTableBodyElement()).focus()},navigate:function(a,b){this.cellEditStop();this.execute(new n(this,a,b))},navigateRow:function(a){this.navigate(this.getCellRow()+a,this.getCellCol())},navigateCol:function(a){this.navigate(this.getCellRow(),this.getCellCol()+a)},navigatePageUp:function(){this.navigateRow(-this.settings.maxPageSize)},navigatePageDown:function(){this.navigateRow(+this.settings.maxPageSize)},navigateUp:function(){this.navigateRow(-1)},navigateDown:function(){this.navigateRow(1)},
...
var f=function(a){this._plugin=a;this.saveState()};f.prototype.execute=function(){};f.prototype.equals=function(a){return"undefined"===typeof a?!1:Object.equals(this.getState(),a.getState())};f.prototype.undo=function(){this.getPlugin().cellStateRestore(this.getState())};f.prototype.saveState=function(){this.setState(this.getPlugin().cellStateRetrieve())};f.prototype.setState=function(a){this._state=a};f.prototype.getState=function(){return this._state};f.prototype.getPlugin=function(){return this._plugin};
var n=function(a,b,c){a=f.call(this,a)||this;a._row=b;a._col=c;return a};$jscomp.inherits(n,f);n.prototype.execute=function(){this.getPlugin()._navigate(this._row,this._col)};var p=function(a){return f.call(this,a)||this};$jscomp.inherits(p,f);p.prototype.execute=function(){var a=this.getPlugin();a.cellCopy();a.cellErase()};var q=function(a,b){return f.call(this,a)||this};$jscomp.inherits(q,f);q.prototype.execute=function(){var a=this.getPlugin(),d=b(a.getTableCell()),c=a.cellInputCreate(d);a.setCellInput(c);
c.on("focusout",function(){d.text(c.val())});d.html(c);c.focus()};var h=function(a,b){a=f.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(h,f);h.prototype.execute=function(){var a=this.getPlugin();b(a.getTableCell()).text(this._cellValue)};var k=function(a){return f.call(this,a)||this};$jscomp.inherits(k,f);k.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var c=b(a.getTableCell()).closest("tr"),e=c.clone();this.setState({id:performance.now(),clone:e});c.after(e);a.activate()};
