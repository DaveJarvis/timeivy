...
function(d){var b="number"===typeof d.which?d.which:d.keyCode;"keypress"!==d.type||!b||d.ctrlKey||d.metaKey||a.editStart(String.fromCharCode(b))})},unbindPrintableKeys:function(){b(this.getTableBodyElement()).off("keypress")},_bindDispatchKeys:function(a){Mousetrap.reset();for(var b=this,c={},e=0;e<a.length;c={f:c.f},e++){var f=a[e].k;c.f=a[e].f;Mousetrap.bind(f,function(a){return function(d){b[a.f]()}}(c))}},bindNavigateMode:function(){this._bindDispatchKeys(this.settings.dispatchKeysNavigate)},
bindEditMode:function(){this._bindDispatchKeys(this.settings.dispatchKeysEdit)},bindPasteHandler:function(){var a=this;b(e).on("paste",function(b){if(b.originalEvent){var d=b.originalEvent.clipboardData.getData("text");a.cellUpdate(d);b.stopPropagation();b.preventDefault()}})},_sanitizeCellIndex:function(a,b){return a>b?b:0>a?0:a},getTableBodyElement:function(){return b(this.element)[0]},getCellRow:function(){return this._cell[0]},getCellCol:function(){return this._cell[1]},setCellRow:function(a){this._cell[0]=
