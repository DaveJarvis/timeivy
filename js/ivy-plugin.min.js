...
function(a){this._state=a};f.prototype.getState=function(){return this._state};f.prototype.getPlugin=function(){return this._plugin};var n=function(a,b,c){a=f.call(this,a)||this;a._row=b;a._col=c;return a};$jscomp.inherits(n,f);n.prototype.execute=function(){this.getPlugin()._navigate(this._row,this._col)};var p=function(a){return f.call(this,a)||this};$jscomp.inherits(p,f);p.prototype.execute=function(){var a=this.getPlugin();a.cellCopy();a.cellErase()};var q=function(a,b){var d=f.call(this,a)||
this;b&&a.cellClear();return d};$jscomp.inherits(q,f);q.prototype.execute=function(){var a=this.getPlugin();a.bindEditMode();a.unbindPrintableKeys();var d=b(a.getTableCell()),c=a.cellInputCreate(d);a.setCellInput(c);c.on("focusout",function(){a.cellEditStop()});d.html(c);c.focus()};var k=function(a,b){a=f.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(k,f);k.prototype.execute=function(){this.getPlugin().setActiveCellValue(this._cellValue)};var h=function(a){return f.call(this,a)||this};
$jscomp.inherits(h,f);h.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var d=b(a.getTableCell()).closest("tr"),c=d.clone();this.setState({id:this.getId(),clone:c});d.after(c);a.activate()};h.prototype.undo=function(){this.getState().clone.remove()};h.prototype.getId=function(){return(new Date).getTime()};c.Plugin=m})(jQuery,window,document);Array.prototype.peek=function(){return this[this.length-1]};
