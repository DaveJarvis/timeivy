...
function(a){this._state=a};f.prototype.getState=function(){return this._state};f.prototype.getPlugin=function(){return this._plugin};var n=function(a,b,d){a=f.call(this,a)||this;a._row=b;a._col=d;return a};$jscomp.inherits(n,f);n.prototype.execute=function(){this.getPlugin()._navigate(this._row,this._col)};var p=function(a){return f.call(this,a)||this};$jscomp.inherits(p,f);p.prototype.execute=function(){var a=this.getPlugin();a.cellCopy();a.cellErase()};var q=function(a,b){return f.call(this,a)||
this};$jscomp.inherits(q,f);q.prototype.execute=function(){var a=this.getPlugin();a.bindEditMode();a.unbindPrintableKeys();var c=b(a.getTableCell()),d=a.cellInputCreate(c);a.setCellInput(d);d.on("focusout",function(){a.cellEditStop()});c.html(d);d.focus()};var k=function(a,b){a=f.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(k,f);k.prototype.execute=function(){this.getPlugin().setCellValue(this._cellValue)};var h=function(a){return f.call(this,a)||this};$jscomp.inherits(h,f);h.prototype.execute=
function(){var a=this.getPlugin();a.deactivate();var c=b(a.getTableCell()).closest("tr"),d=c.clone();this.setState({id:this.getId(),clone:d});c.after(d);a.activate()};h.prototype.undo=function(){this.getState().clone.remove()};h.prototype.getId=function(){return(new Date).getTime()};d.Plugin=m})(jQuery,window,document);Array.prototype.peek=function(){return this[this.length-1]};
