...
navigateRowEnd:function(){this.navigateCol(1E3)},cellCut:function(){this.execute(new p(this))},cellCopy:function(){var a=b("<input>");b("body").append(a);a.val(b(this.getTableCell()).text()).select();e.execCommand("copy");a.remove()},cellErase:function(){this.execute(new k(this,""))},cellInputCreate:function(a){a.addClass(this.settings.classActiveCellInput);var c=a.width();a=a.text();var d=b("<input>");d.prop({type:"text",value:a});d.css({width:c,"max-width":c});return d},cellInputDestroy:function(){var a=
this.getCellInput(),c=a.val();a.remove();this.setCellInput(!1);return c},getCellInput:function(){return this._$cellInput},setCellInput:function(a){this._$cellInput=a},cellEditStart:function(a){this.isActiveCellReadOnly()||this.execute(new q(this,a))},cellEditStop:function(){var a=!1;!1!==this.getCellInput()&&(a=this.cellInputDestroy(),b(this.getTableCell()).removeClass(this.settings.classActiveCellInput),this.setActiveCellValue(a),this.focus(),this.bindNavigateMode(),this.bindPrintableKeys(),a=!0);
return a},setCellValue:function(a,c,d){a=this.settings.onCellValueChange(a,c,d);b(this.getCellValue(c,d)).text(a)},setActiveCellValue:function(a){var c=this.getCellRow(),b=this.getCellCol();this.setCellValue(a,c,b)},setActiveCellValueSilent:function(a){!1!==a&&b(this.getTableCell()).text(a)},cellEditCancel:function(){this.cellEditStop()&&this.editUndo()},editSave:function(){console.log("Save cells")},editInsertRow:function(){this.execute(new h(this))},editUndo:function(){this.getCommandExecutor().undo()},
editRedo:function(){this.getCommandExecutor().redo()}});b.fn.ivy=function(a){return this.each(function(){if(!b.data(this,"plugin_ivy")){var c=new m(this,a);b.data(this,"plugin_ivy",c)}})};var g=function(){this._undoStack=[];this._redoStack=[]};g.prototype.getUndoStack=function(){return this._undoStack};g.prototype.getRedoStack=function(){return this._redoStack};g.prototype.execute=function(a){a.execute();var c=this.getUndoStack(),b=c.peek();a.equals(b)||c.push(a)};g.prototype.undo=function(){var a=
this.getUndoStack().pop();"undefined"!==typeof a&&(a.undo(),this.getRedoStack().push(a))};g.prototype.redo=function(){var a=this.getRedoStack().pop();"undefined"!==typeof a&&this.execute(a)};var f=function(a){this._plugin=a;this.saveState()};f.prototype.execute=function(){};f.prototype.equals=function(a){return"undefined"===typeof a?!1:Object.equals(this.getState(),a.getState())};f.prototype.undo=function(){this.getPlugin().cellStateRestore(this.getState())};f.prototype.saveState=function(){this.setState(this.getPlugin().cellStateRetrieve())};
f.prototype.setState=function(a){this._state=a};f.prototype.getState=function(){return this._state};f.prototype.getPlugin=function(){return this._plugin};var n=function(a,b,d){a=f.call(this,a)||this;a._row=b;a._col=d;return a};$jscomp.inherits(n,f);n.prototype.execute=function(){this.getPlugin()._navigate(this._row,this._col)};var p=function(a){return f.call(this,a)||this};$jscomp.inherits(p,f);p.prototype.execute=function(){var a=this.getPlugin();a.cellCopy();a.cellErase()};var q=function(a,b){var c=
f.call(this,a)||this;a.setActiveCellValueSilent(b);return c};$jscomp.inherits(q,f);q.prototype.execute=function(){var a=this.getPlugin();a.bindEditMode();a.unbindPrintableKeys();var c=b(a.getTableCell()),d=a.cellInputCreate(c);a.setCellInput(d);d.on("focusout",function(){a.cellEditStop()});c.html(d);d.focus()};var k=function(a,b){a=f.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(k,f);k.prototype.execute=function(){this.getPlugin().setActiveCellValue(this._cellValue)};var h=function(a){return f.call(this,
a)||this};$jscomp.inherits(h,f);h.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var c=b(a.getTableCell()).closest("tr"),d=c.clone();this.setState({id:this.getId(),clone:d});c.after(d);a.activate()};h.prototype.undo=function(){this.getState().clone.remove()};h.prototype.getId=function(){return(new Date).getTime()};d.Plugin=m})(jQuery,window,document);Array.prototype.peek=function(){return this[this.length-1]};
Object.equals=function(b,d){if(!(b instanceof Object&&d instanceof Object))return!1;for(var e in b)if(b.hasOwnProperty(e)&&(!d.hasOwnProperty(e)||b[e]!==d[e]&&!Object.equals(b[e],d[e])))return!1;return!0};
