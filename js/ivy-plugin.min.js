...
$jscomp.inherits=function(b,d){b.prototype=$jscomp.objectCreate(d.prototype);b.prototype.constructor=b;if($jscomp.setPrototypeOf){var f=$jscomp.setPrototypeOf;f(b,d)}else for(f in d)if("prototype"!=f)if(Object.defineProperties){var l=Object.getOwnPropertyDescriptor(d,f);l&&Object.defineProperty(b,f,l)}else b[f]=d[f];b.superClass_=d.prototype};
(function(b,d,f,l){function m(a,c){this.element=a;this.settings=b.extend({},t,c);this.settings.ivy=this;this._defaults=t;this._name="ivy";this._cell=[0,0];this._$cellInput=!1;this._commandExecutor=new g;this.init()}var t={classActiveCell:"active",classActiveCellInput:"edit",classCellReadOnly:"readonly",maxPageSize:30,columns:[],dispatchKeysNavigate:[{k:"enter",f:"navigateDown"},{k:"up",f:"navigateUp"},{k:"down",f:"navigateDown"},{k:"left",f:"navigateLeft"},{k:"right",f:"navigateRight"},{k:"ctrl+up",
...
c.stopPropagation();c.preventDefault()}})},_sanitizeCellIndex:function(a,c){return a>c?c:0>a?0:a},getCellRow:function(){return this._cell[0]},getCellCol:function(){return this._cell[1]},getTableBodyElement:function(){return b(this.element)[0]},getActiveCell:function(){var a=this.getCellRow(),c=this.getCellCol();return this.getCell(a,c)},getCell:function(a,c){return this.getTableBodyElement().rows[a].cells[c]},setCellRow:function(a){this._cell[0]=this._sanitizeCellIndex(a,this.getMaxRows())},setCellCol:function(a){this._cell[1]=
this._sanitizeCellIndex(a,this.getMaxCols())},getMaxRows:function(){return this.getTableBodyElement().rows.length-1},getMaxCols:function(){return this.getTableBodyElement().rows[0].cells.length-1},isActiveCell:function(a,c){return this.isActiveCellRow(a)&&this.isActiveCellCol(c)},isActiveCellRow:function(a){return a===this.getCellRow()},isActiveCellCol:function(a){return a===this.getCellCol()},isActiveCellReadOnly:function(){return b(this.getActiveCell()).hasClass(this.settings.classCellReadOnly)},
...
navigateHome:function(){this.navigate(0,0)},navigateEnd:function(){this.navigate(1E3,1E3)},navigateRowHome:function(){this.navigateCol(-1E3)},navigateRowEnd:function(){this.navigateCol(1E3)},editCut:function(){this.execute(new p(this))},editCopy:function(){var a=b("<input>");b("body").append(a);a.val(b(this.getActiveCell()).text()).select();f.execCommand("copy");a.remove()},editErase:function(){this.cellUpdate("")},cellUpdate:function(a){this.isActiveCellReadOnly()||this.execute(new q(this,a))},cellInputCreate:function(a){a.addClass(this.settings.classActiveCellInput);
var c=a.width();a=a.text();var d=b("<input>");d.prop({type:"text",value:a});d.css({width:c,"max-width":c});return d},cellInputDestroy:function(){var a=this.getCellInput(),c=a.val();a.remove();this.setCellInput(!1);return c},getCellInput:function(){return this._$cellInput},setCellInput:function(a){this._$cellInput=a},editStart:function(a){this.isActiveCellReadOnly()||this.execute(new r(this,a))},editStop:function(){var a=!1;!1!==this.getCellInput()&&(a=this.cellInputDestroy(),b(this.getActiveCell()).removeClass(this.settings.classActiveCellInput),
this.setActiveCellValue(a),this.focus(),this.bindNavigateMode(),this.bindPrintableKeys(),a=!0);return a},setCellValue:function(a,c,d){a=this.settings.onCellValueChangeBefore(a,c,d);b(this.getCell(c,d)).text(a);this.settings.onCellValueChangeAfter(c,d)},setActiveCellValue:function(a){var c=this.getCellRow(),b=this.getCellCol();this.setCellValue(a,c,b)},setActiveCellValueSilent:function(a){!1!==a&&b(this.getActiveCell()).text(a)},editCancel:function(){this.editStop()&&this.editUndo()},editSave:function(){console.log("Save cells")},
editInsertRow:function(){this.execute(new h(this))},editDeleteRow:function(){this.execute(new k(this))},editUndo:function(){this.getCommandExecutor().undo()},editRedo:function(){this.getCommandExecutor().redo()}});var g=function(){this._undoStack=[];this._redoStack=[]};g.prototype.getUndoStack=function(){return this._undoStack};g.prototype.getRedoStack=function(){return this._redoStack};g.prototype.execute=function(a){a.execute();var c=this.getUndoStack(),b=c.peek();a.equals(b)||c.push(a)};g.prototype.undo=
function(){var a=this.getUndoStack().pop();"undefined"!==typeof a&&(a.undo(),this.getRedoStack().push(a))};g.prototype.redo=function(){var a=this.getRedoStack().pop();"undefined"!==typeof a&&this.execute(a)};var e=function(a){this._plugin=a;this.saveState()};e.prototype.execute=function(){};e.prototype.equals=function(a){return"undefined"===typeof a?!1:Object.equals(this.getState(),a.getState())};e.prototype.undo=function(){this.getPlugin().cellStateRestore(this.getState())};e.prototype.getId=function(){return(new Date).getTime()};
e.prototype.saveState=function(){this.setState(this.getPlugin().cellStateRetrieve())};e.prototype.setState=function(a){this._state=a};e.prototype.getState=function(){return this._state};e.prototype.getPlugin=function(){return this._plugin};var n=function(a,c,b){a=e.call(this,a)||this;a._row=c;a._col=b;return a};$jscomp.inherits(n,e);n.prototype.execute=function(){this.getPlugin()._navigate(this._row,this._col)};var p=function(a){return e.call(this,a)||this};$jscomp.inherits(p,e);p.prototype.execute=
function(){var a=this.getPlugin();a.editCopy();a.editErase()};var r=function(a,c){var b=e.call(this,a)||this;a.setActiveCellValueSilent(c);return b};$jscomp.inherits(r,e);r.prototype.execute=function(){var a=this.getPlugin();a.bindEditMode();a.unbindPrintableKeys();var c=b(a.getActiveCell()),d=a.cellInputCreate(c);a.setCellInput(d);d.on("focusout",function(){a.editStop()});c.html(d);d.focus()};var q=function(a,b){a=e.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(q,e);q.prototype.execute=
function(){this.getPlugin().setActiveCellValue(this._cellValue)};var h=function(a){return e.call(this,a)||this};$jscomp.inherits(h,e);h.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var c=b(a.getActiveCell()).closest("tr"),d=c.clone();this.setState({id:this.getId(),clone:d});c.after(d);a.settings.onRowInsertAfter(c,d);a.activate()};h.prototype.undo=function(){this.getState().clone.remove()};var k=function(a){return e.call(this,a)||this};$jscomp.inherits(k,e);k.prototype.execute=
function(){var a=this.getPlugin();a.deactivate();var c=b(a.getActiveCell()).closest("tr");this.setState({id:this.getId(),row:c});c.remove();a.settings.onRowDeleteAfter(c);a.activate()};k.prototype.undo=function(){console.log("delete row")};b.fn.ivy=function(a){this.each(function(){if(!b.data(this,"plugin_ivy")){var c=new m(this,a);b.data(this,"plugin_ivy",c)}});return b.data(this,"plugin_ivy",plugin)};d.Plugin=m})(jQuery,window,document);Array.prototype.peek=function(){return this[this.length-1]};
Object.equals=function(b,d){if(!(b instanceof Object&&d instanceof Object))return!1;for(var f in b)if(b.hasOwnProperty(f)&&(!d.hasOwnProperty(f)||b[f]!==d[f]&&!Object.equals(b[f],d[f])))return!1;return!0};
