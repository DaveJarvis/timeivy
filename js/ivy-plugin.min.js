...
this.navigate(a,b)},bindNavigationClicks:function(){var a=this,b=c(a.getTableBodyElement());b.on("click","td",function(){a.navigateTableCell(c(this))});b.on("dblclick","td",function(){a.navigateTableCell(c(this));a.cellEditStart()})},bindPrintableKeys:function(){var a=c(this.getTableBodyElement());a.keypress(function(a){var b="number"===typeof a.which?a.which:a.keyCode;"keypress"===a.type&&b&&!a.ctrlKey&&console.log("KEYPRESS!")});a.focus()},bindNavigateMode:function(){Mousetrap.reset();for(var a=
...
return b},getCellInput:function(){return this._$cellInput},setCellInput:function(a){this._$cellInput=a},cellEditStart:function(){var a=c(this.getTableCell()),b=this.cellInputCreate(a);this.setCellInput(b);b.on("focusout",function(){a.text(b.val())});a.html(b);b.focus()},cellEditStop:function(){if(!1!==this.getCellInput()){var a=this.cellInputDestroy(),b=c(this.getTableCell());b.removeClass(this.settings.classActiveCellInput);b.text(a)}c(plugin.getTableBodyElement()).focus()},cellEditCancel:function(){console.log("Edit cancel");
