...
a.getState())};e.prototype.undo=function(){this.getPlugin().cellStateRestore(this.getState())};e.prototype.getId=function(){return(new Date).getTime()};e.prototype.saveState=function(){this.setState(this.getPlugin().cellStateRetrieve())};e.prototype.setState=function(a){this._state=a};e.prototype.getState=function(){return this._state};e.prototype.getPlugin=function(){return this._plugin};var n=function(a,c,b){a=e.call(this,a)||this;a._row=c;a._col=b;return a};$jscomp.inherits(n,e);n.prototype.execute=
function(){this.getPlugin()._navigate(this._row,this._col)};var p=function(a){return e.call(this,a)||this};$jscomp.inherits(p,e);p.prototype.execute=function(){var a=this.getPlugin();a.editCopy();a.editErase()};var r=function(a,c){var b=e.call(this,a)||this;a.setActiveCellValueSilent(c);return b};$jscomp.inherits(r,e);r.prototype.execute=function(){var a=this.getPlugin();a.bindEditMode();a.unbindPrintableKeys();var c=b(a.getActiveCell()),d=a.cellInputCreate(c);a.setCellInput(d);d.on("focusout",function(){a.editStop()});
c.html(d);d.focus()};var q=function(a,b){a=e.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(q,e);q.prototype.execute=function(){this.getPlugin().setActiveCellValue(this._cellValue)};var h=function(a){return e.call(this,a)||this};$jscomp.inherits(h,e);h.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var c=b(a.getActiveCell()).closest("tr"),d=c.clone();this.setState({id:this.getId(),clone:d});c.after(d);a.settings.onRowInsertAfter(c,d);a.activate()};h.prototype.undo=
function(){this.getState().clone.remove()};var k=function(a){return e.call(this,a)||this};$jscomp.inherits(k,e);k.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var c=b(a.getActiveCell()).closest("tr");this.setState({id:this.getId(),row:c});c.remove();a.settings.onRowDeleteAfter(c);a.activate()};k.prototype.undo=function(){console.log("delete row")};d.Plugin=m})(jQuery,window,document);Array.prototype.peek=function(){return this[this.length-1]};
