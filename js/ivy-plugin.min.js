...
this._col)};var r=function(a){return f.call(this,a)||this};$jscomp.inherits(r,f);r.prototype.execute=function(){var a=this.getPlugin();a.editCopy();a.editErase()};var u=function(a,b){a=f.call(this,a)||this;a._charCode=b;return a};$jscomp.inherits(u,f);u.prototype.execute=function(){var a=this.getPlugin();a.bindEditMode();a.unbindPrintableKeys();var d=b(a.getActiveCell()),c=a.cellInputCreate(d,this._charCode);console.log(d.html());a.setCellInput(c);d.html(c);c.focus();c.on("focusout",function(){a.editStop()})};
var t=function(a,b){a=f.call(this,a)||this;a._cellValue=b;return a};$jscomp.inherits(t,f);t.prototype.execute=function(){this.getPlugin().setActiveCellValue(this._cellValue)};var k=function(a){return f.call(this,a)||this};$jscomp.inherits(k,f);k.prototype.execute=function(){var a=this.getPlugin();a.deactivate();var b=this.getRow().clone();this.setState({id:this.getId(),clone:b});this.inject(b);a.activate()};k.prototype.inject=function(a){var b=this.getRow();b.after(a);this.getPlugin().settings.onRowInsertAfter(b,
